        ...
        <div class="container">
            <div class="row">
                <div class="col-xs-8 col-xs-offset-2 box">
                    <h1><spring:message code="lbl.login" text="Login"></spring:message></h1>
                    <form action="login" method="POST">
                        ...
                        <div class="actions pull-right">
                        	<spring:message code="lbl.login" var="login" text="Login"/>
                            	<input type="submit" value="${login}" class="btn btn-primary">
                            	<spring:message code="lbl.or" text="or"></spring:message>
                            <a href="inscription" class="btn btn-default">
                            	<spring:message code="lbl.inscription" text="Inscription"></spring:message>
                            </a>
                        </div>
